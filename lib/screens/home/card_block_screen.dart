...
import 'package:zelyo_1/providers/card_block_provider.dart';
...
class CardBlockScreen extends ConsumerStatefulWidget {
  const CardBlockScreen({super.key});

  @override
  ConsumerState<CardBlockScreen> createState() => _CardBlockScreenState();
}

class _CardBlockScreenState extends ConsumerState<CardBlockScreen> {
  ...
  Future<void> _onContinueTap() async {
    final selectedReasonIndex =
        ref.read(cardBlockProvider).selectedReasonIndex;
  ...
  Widget build(BuildContext context) {
    final blockState = ref.watch(cardBlockProvider);

    final selectedReasonIndex =
        blockState.selectedReasonIndex;
