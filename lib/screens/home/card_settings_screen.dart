...
class CardSettingsScreen extends StatelessWidget {
  ...
  Future<void> _onChangePinTap(BuildContext context) async {
    final verified = await Navigator.of(context).push<bool>(
      MaterialPageRoute(
        builder: (context) => const VerifyTransactionPinScreen(
          purpose: 'Verify your mobile PIN before changing your card PIN',
        ),
      ),
    );
  ...
  Future<void> _onDeleteCardTap(BuildContext context) async {
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.delete_outline_rounded, color: AppColors.danger, size: 30),
              ),
    ...
    if (confirmed == true && context.mounted) {
      // Pop settings itself, returning `true` so CardScreen can react
      // (e.g. reset to the "no card" state).
                  ...
                  children: [
                    ...
                    _buildSettingsCard(context, [
                      _SettingsItem(
                        ...
                        label: 'Custom name',
                        onTap: () => _showComingSoonSnackBar(context, 'Custom name'),
                      ),
                      _SettingsItem(
                      ...
                      _SettingsItem(
                        ...
                        label: 'Card limit',
                        onTap: () => _showComingSoonSnackBar(context, 'Card limit'),
                      ),
                    ]),
                    ...
                    _buildSettingsCard(context, [
                      _SettingsItem(
                        ...
                        label: 'Delete card',
                        isDestructive: true,
                        onTap: () => _onDeleteCardTap(context),
                      ),
                    ]),
                  ],
                ),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const Text('Card settings', style: TextStyle(color: AppColors.textPrimary, fontSize: 19, fontWeight: FontWeight.w800)),
        ],
      ),
    );
  }
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: Icon(
                          item.icon,
                          color: item.isDestructive ? AppColors.danger : AppColors.primaryBlueLight,
                          size: 19,
                        ),
                      ),
